  ...
  return (
    ...
    <>
      <section className="upsellItems">
        ...
        <img
          src={"productPics/product" + (upsellItems[0].product.id ? upsellItems[0].product.id : 0)  + ".jpg"}
        ...
        <ul>
          ...
          <ul>
            <b>Price {(upsellItems[0].product.price ? upsellItems[0].product.price : upsellItems[0].product.price)}</b>
          </ul>
          <button
